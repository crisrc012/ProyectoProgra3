...
using Proyecto_Progra3_DAL.Catalogos_Mantenimientos.Estados;

namespace Proyecto_Progra3_BLL.Catalogos_Mantenimientos.Estados
{
    public class Cls_estados_BLL
    {
        ...
        public void filtrar_estados(ref Cls_estados_DAL Obj_estados_DAL)
        {
