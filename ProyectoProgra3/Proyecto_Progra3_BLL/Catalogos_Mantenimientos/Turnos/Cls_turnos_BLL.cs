...
using Proyecto_Progra3_DAL.Catalogos_Mantenimientos.Turnos;

namespace Proyecto_Progra3_BLL.Catalogos_Mantenimientos.Turnos
{
    public class Cls_turnos_BLL
    {
        ...
        public void filtrar_turnos(ref Cls_turnos_DAL Obj_turnos_DAL)
        {
