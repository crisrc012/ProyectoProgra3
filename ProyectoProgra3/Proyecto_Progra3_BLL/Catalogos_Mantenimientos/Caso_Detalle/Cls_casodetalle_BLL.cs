...
using Proyecto_Progra3_DAL.Catalogos_Mantenimientos.Caso_Detalle;

namespace Proyecto_Progra3_BLL.Catalogos_Mantenimientos.Caso_Detalle
{
    public class Cls_casodetalle_BLL
    {
        ...
        public void filtrar_casodetalle(ref Cls_casodetalle_DAL Obj_casodetalle_DAL)
        {
