...
using Proyecto_Progra3_DAL.Catalogos_Mantenimientos.Semaforo_Casos;

namespace Proyecto_Progra3_BLL.Catalogos_Mantenimientos.Semaforo_Casos
{
   public class Cls_semaforo_BLL
    {
        ...
        public void filtrar_semaforo(ref Cls_semaforo_DAL Obj_semaforo_DAL)
        {
